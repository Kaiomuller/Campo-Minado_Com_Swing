...
import br.com.codar.cm.modelo.Campo;
import br.com.codar.cm.modelo.CampoEvento;
import br.com.codar.cm.modelo.CampoObservador;

@SuppressWarnings("serial")
public class BotaoCampo extends JButton implements CampoObservador, MouseListener{
	
	private final Color BG_PADRAO = new Color(184, 184, 184);
	private final Color BG_MARCAR= new Color(1, 179, 247);
